...
@section('title', $test->name . ' - Лагерь креативных лидеров')
                    ...
                    <div class="section-main-primary">
                        <div class="row">
                            ...
                            <div class="col-12">
                                ...
                                @if($test->description)
                                <div class="section-main-content">{{ $test->description }}</div>
                                @endif
                            </div>
                                ...
                                <div class="section-main-action">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-lg">
                                            <a href="https://t.me/CreativeLeadersCamp" target="_blank" class="btn btn-yellow btn-icon h-100 w-100 w-lg-auto">
                                                <span class="btn-icon-text">
                                                    <span class="d-none d-lg-inline">Telegram чат</span> для <span class="d-inline d-lg-none">связи</span> <span class="d-none d-md-inline">коммуникации</span> и мастермайндов
                                                </span>
...
@include('course.modal.finish-one')
@include('course.modal.finish-all')
@endsection
...
@section('scripts')
@vite('resources/js/pages/course/test.js')
@endsection