...
@section('head')
@vite('resources/scss/pages/landing/reels.scss')
@endsection
    ...
    <div class="container">
        <div class="section-main-inner">
            ...
            <div class="section-main-description wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.5s">
                <div class="text-6">
                    Собрали для тебя короткие ролики на основе <br class="d-inline d-md-none">нашего авторского курса, <br class="d-none d-md-inline">
                    чтобы познакомить <br class="d-inline d-md-none">с сутью дизайн-мышления, раскрыть <br class="d-inline d-md-none">креативность <br class="d-none d-md-inline">
                    как навык и получить базовые <br class="d-inline d-md-none">инструменты осознанного лидерства.
                </div>
            </div>
            <div class="section-main-background">
                <img src="/assets/images/pages/course/index/1.svg" class="lazyload wow fadeInUp" data-wow-duration="1s" data-wow-delay="1s">
            </div>
        </div>
    </div>
</section>

@include('landing.sections.courses')
...
<div class="modal modal-certificate" data-modal-id="reels-certificate">
    <div class="modal-dialog">
        <div class="modal-content">
            <button type="button" class="modal-close" btn-close-modal></button>
            <div class="modal-header">
                <h5 class="modal-title">
                    Вы прошли Reels-курс!
                </h5>
            </div>
            <div class="modal-body">
                <div class="row g-3">
                    <div class="col-12">
                        <!-- <div class="modal-certificate-cover">
                            <img data-src="/assets/images/pages/landing/courses/example.svg" class="lazyload" />
                        </div> -->
                        <p>
                            Поздравляю! Вам доступен сертификат о прохождении Reels-курса. Дарим сертификат и промокод на скидку.
                        </p>
                    </div>
                    <div class="col-12 text-center">
                        <p>
                            Промокод на скидку на основной курс:
                        </p>
                        <p class="fw-700">
                            Reels20
                        </p>
                    ...
                    <div class="col-12">
                        <a href="/docs/cert_reels_001.pdf" target="_blank" class="btn btn-primary w-100">
                            Скачать сертификат
                        </a>
                    </div>
                </div>
...
@section('scripts')
@vite('resources/js/pages/landing/reels.js')
@endsection